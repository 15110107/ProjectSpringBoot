...
public class Controller {
    ...
    public ResponseEntity<List<ModelResponse>> getModelResponse(@RequestBody ModelRequest ModelRequest) {
        try {
            ...
            String sql = "EXEC sp_GETTBL_ForAndroid_ByCodeMap_CongNo_KhachHang_Duong '" + mDateto + "','"
                    + mMappingCodeType + "'";
            List<ModelResponse> ModelResponses = jdbcTemplate.query(sql,
                    BeanPropertyRowMapper.newInstance(ModelResponse.class));
